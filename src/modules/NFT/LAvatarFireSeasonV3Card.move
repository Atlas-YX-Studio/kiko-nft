...
module LAvatarFireSeasonV3Card {
    ...
    use 0x1::NFTGallery;
    use 0x69f1e543a3bef043b63bed825fcd2cf6::LAvatarFireSeasonV1Card::{Self, KikoCatMeta, KikoCatBody};
    ...
    public(script) fun composite_original_card(
        ...
        let nft = LAvatarFireSeasonV1Card::composite_original_card_from_external(
            _sender,
            name,
            image,
            description,
